  ...
  return (
    ...
    >
      ...
      <FocusTrap focusTrapOptions={focusTrapOptions}>
        <div
          ref={containerRef}
          className="relative flex flex-col items-center gap-8 z-10 w-full max-w-lg mt-20 mx-auto px-6 sm:px-10 py-8 bg-white rounded-lg shadow-2xl overflow-hidden"
          tabIndex={-1}
        >
